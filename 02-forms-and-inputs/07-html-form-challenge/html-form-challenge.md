...
- <del> A header at the top of the form that says "Apartment Search"</del>
- <del>Location (text input)</del>
- <del>Monthly Price (range or number input)</del>
- <del>Number of Bedrooms (number input)</del>
- <del>Number of Bathrooms (number input)</del>
- <del>Pets Allowed (checkbox)</del>
